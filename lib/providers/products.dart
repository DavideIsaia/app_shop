...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    var url =
        'https://david-shop-default-rtdb.europe-west1.firebasedatabase.app/products.json?auth=$authToken&$filterString';
    try {
      ...
      url =
          'https://david-shop-default-rtdb.europe-west1.firebasedatabase.app/user-favorites/$userId/.json?auth=$authToken';
